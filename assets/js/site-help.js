...
const SiteHelp = {
  descriptions: {
    ...
    'promotion': '🎓 **Promotion** — The end-of-session engine, in three clear steps: ① ⚙ Auto-promote (by exam) drafts promote/repeat/graduate for every student from their exam averages vs your pass benchmark; ② review and adjust any draft; ③ **✅ Apply promotions** — one click, with a full preview of class movements, then promoted students MOVE to their new classes automatically (every page follows instantly), graduates become alumni-ready, and each report card prints the decision (PROMOTED TO…, REPEAT, GRADUATED).',
