    ...
    try{
      ...
      const assembled=[...groups.values()].map(g=>{
        ...
        applicable.forEach((c,index)=>{
          ...
          used.add(field); out._assessmentMax[field]+=max; out._assessmentValues[c.name]=value;
